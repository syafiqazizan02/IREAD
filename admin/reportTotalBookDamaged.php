...
<?php
    ...
    $sql = 'SELECT YEAR(book_damage) FROM book
        WHERE book_remark = 1
        GROUP BY YEAR(book_damage) ORDER BY YEAR(book_damage) DESC';
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Total Damaged Book</li>
                        </ol>
                    </div>
                </div>
            </div>
                  ...
                  <div class="col-md-12">
                      <div class="card">
                          <div class="card-header">
                              <small>Total Damaged Book</small>
                          </div>
                          <div class="card-body">
                            <div class="row form-group">
                                    ...
                                    <div class="col col-md-7">
                                        ...
                                        while($row = $result->fetch_assoc()){
                                            echo '<option value="'.$row['YEAR(book_damage)'].'">'.$row['YEAR(book_damage)'].'</option>';
                                        }
                                        ?>
                                    </select>
                                    </div>
