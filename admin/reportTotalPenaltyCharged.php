...
<?php
    ...
    WHERE `return`.penalty_amount>0 GROUP BY YEAR(done_date)';
              ...
              <div class="page-header float-right">
                  <div class="page-title">
                      <ol class="breadcrumb text-right">
                          ...
                          <li class="active">Total Penalty Charged</li>
                      </ol>
                  </div>
              </div>
          </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <small>Total Penalty Charged</small>
                        </div>
                        <div class="card-body">
        ...
        $('#year_choosen').change(function(){
          ...
          $('#chart').append('<canvas id="sales-chart"></canvas>');
            ...
            if(year1){
                $.ajax({
                    type:'POST',
                    url:'ajax_TotalPenaltyCharged.php',
                    dataType:"JSON",
                    data:{year:year1},
                    cache: false,
