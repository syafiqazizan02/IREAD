        ...
        <div class="modal-dialog modal-lg" >
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" class="modal-header">Manage Member   <small>Reset Password</small></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-9"><input type="text" name="member_email" value="<?php echo $member_email; ?>" class="form-control" readonly="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required></div>
                    </div>
                    <div style="height:10px;"></div>
                    <div class="row">
                ...
                <div class="modal-footer">
                  	<button type="submit"  name="submit" class="btn btn-success btn-md"><span class="fa fa-gear"></span>&nbsp;Reset Password</button>
                </div>
				       </form>
            </div>
        </div>
