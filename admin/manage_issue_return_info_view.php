<!-- modal-->
     <div class="modal fade" id="viewreturn<?php echo $return_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
        <div class="modal-dialog modal-lg" >
            <div class="modal-content">
                ...
                <?php
                    ...
                    $query = mysqli_query($conn, "SELECT  c.borrow_date as borrow_date, c.due_date as due_date, e.member_ic as member_ic, e.member_fullname as member_fullname, g.done_date as done_date
                                                  FROM `return` AS a
                ...
                <div class="modal-body">
        					...
        					<div style="height:10px;"></div>
                  <div class="row">
        						<div class="col col-md-3"><label for="text-input" class=" form-control-label">Done Date :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></div>
        						<div class="col-12 col-md-9"><input type="text" class="form-control" value="<?php echo date_format(date_create($done_date), 'd F Y'); ?>" readonly/></div>
                	</div>
        					<div style="height:10px;"></div>
        				</div>
