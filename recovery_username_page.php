...
<body id="page-top">
  ...
  <header class="masthead ">
    <section id="contact">
      <div class="container">
      <h3 align="center">Recovery by Security Question :</h3><br><br>
      <h5 align="center">STEP 1: PLEASE ENTER YOUR MEMBER ID!</h5><br>
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <form action="recovery_username.php" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label></label>
                  <input class="form-control" name="username" type="text" placeholder="Enter Member ID" required>
                </div>
              </div><br>
              <div class="form-group">
                <center>
                  <button type="submit" class="btn btn-warning btn-xl" style="color:white;" name="recovery">Recovery&nbsp;&nbsp;<i class='fa fa-undo'></i></button>&nbsp;&nbsp;
                  <a href="recovery_password.php"><button type="button" class="btn btn-danger btn-xl" name="back">&nbsp;&nbsp;&nbsp;&nbsp;Back&nbsp;&nbsp;<i class='fa fa-chevron-circle-left'></i>&nbsp;&nbsp;&nbsp;&nbsp;</button></a>
                </center>
                </div>
              </form>
            </div>
