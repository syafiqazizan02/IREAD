...
foreach ($displayname as $key)
{
  ...
  $boo = "SELECT book.book_code, book.book_tittle, borrow.borrow_date, borrow.due_date, done.done_date, `return`.penalty_amount
          FROM `return`
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Books Returned</a>
