  ...
  <body id="page-top">
    ...
    <header class="masthead ">
      <section id="contact">
        <div class="container">
        <h3 align="center">Recovery by Email :</h3><br><br>
        <h5 align="center">STEP: PLEASE ENTER YOUR EMAIL!</h5><br>
          <div class="row">
              ...
              <form action="recovery_email.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="control-group">
                  <div class="form-group floating-label-form-group controls mb-0 pb-2">
                    <label></label>
                    <input class="form-control"  name="email" type="email" placeholder="Enter Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
                  </div>
                </div><br>
