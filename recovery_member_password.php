      ...
      <h5 align="center">STEP 3: CHANGE YOUR PASSSWORD!</h5><br>
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <form action="recovery_member_password.php" method="post" enctype="multipart/form-data" class="form-horizontal">
...
<?php
    	...
    	// include "php-mailer-master/PHPMailerAutoload.php";
    		...
    		if(isset($_POST['recovery']))
    		{
    			...
    			{
    				$stmt = $conn->prepare("UPDATE member SET member_password = ? WHERE member_ic=?");
