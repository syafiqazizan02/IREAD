...
<?php
  ...
  foreach ($displayname as $key)
  {
	...
	$boo = "SELECT done.done_id, done.done_date, book.book_tittle, returnss.penalty_day, returnss.penalty_amount FROM returnss INNER JOIN book ON returnss.book_id = book.book_id INNER JOIN done ON returnss.done_id = done.done_id INNER JOIN borrow ON returnss.borrow_id = borrow.borrow_id
