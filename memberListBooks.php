...
foreach ($displayname as $key)
{
  ...
  $boo = "SELECT DISTINCT b.book_isbn as book_isbn, b.book_tittle as book_tittle, d.category_name as book_category, b.book_author as book_author, b.book_publisher as book_publisher
          FROM book AS b
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">List of Books</a>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <strong class="card-title">List of Books</strong>
              </div>
              ...
              <div class="card-body">
                <table  id="bootstrap-data-table" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <?php
                    foreach ($book as $key) {
                       $bookISBN = $key['book_isbn'];
                      $sql="SELECT COUNT(book_isbn) as a from book WHERE book_remark=0 AND book_status=0 AND book_isbn=".$bookISBN." GROUP BY book_isbn";
                      ...
                      <tr align="center">
                        ...
                        <td><?php echo $key['book_tittle']; ?></td>
                        <td><?php echo $key['book_category']; ?></td>
                        <td><?php echo $key['book_author']; ?></td>
                        <td><?php echo $key['book_publisher']; ?></td>
                        <td><?php echo $row['a']; ?> Books</td>
                    <?php } 	?>
                  </tbody>
                </table>
