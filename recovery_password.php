        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
              <div class="control-group">
                    <center><a href="recovery_username_page.php"><button type="submit" class="btn btn-success btn-xl"name="recovery">&nbsp;&nbsp;&nbsp;Recovery by Member ID&nbsp;&nbsp;<i class='fa fa-users'></i>&nbsp;&nbsp;&nbsp;</button></a>
              </div><br>
              <div class="control-group">
                    <center><a href="recovery_email_page.php"><button type="submit" class="btn btn-info btn-xl"name="recovery">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Recovery by Email&nbsp;&nbsp;<i class='fa fa-envelope'></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i></button></a>
              </div>
            </div>
          </div>
        </div>
