  ...
  foreach ($displayname as $key)
  {
    ...
    $boo = "SELECT book.book_code, book.book_tittle, done.done_date, `return`.return_id, `return`.nilam_status
            FROM `return`
    ...
    <div class="container">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">Nilam</a>
    ...
    <strong class="card-title">Nilam Info</strong>
    </div>
    ...
    foreach ($book as $key) {
      ...
      $returnId =  $key['return_id'];
      $done_date = date_format(date_create($key['done_date']), 'd M Y');
      $book_code = $key['book_code'];
      $book_tittle = $key['book_tittle'];
      $nilamStatus = $key['nilam_status'];
      ...
      <td align="center">
      <?php include('nilam2.php'); ?>
      <?php $returnId; ?><a href="#a<?php echo $returnId; ?>" data-toggle="modal" class="btn btn-warning btn-sm" style="color:white"><i class='fa fa-edit'></i></a>
      <?php include('nilam4.php'); ?>
      <?php $returnId; ?><a href="#b<?php echo $returnId; ?>" data-toggle="modal" class="btn btn-info btn-sm" style="color:black"><i class='fa fa-info-circle'></i></a>
      </td>
      </tr>
      <?php } ?>
      </tbody>
